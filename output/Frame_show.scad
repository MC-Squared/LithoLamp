$fn=36;
difference(){union(){difference(){difference(){difference(){union(){difference(){cylinder(h = 138.000, r = 82.500);
...
rotate(a = [0, 0, -60])
difference(){union(){translate(v = [-10.000, -1.250])
...
translate(v = [0, -0.875, -1])
rotate(a = [-45, 0, 0])
#cube(size = [27.000, 3.500, 14.000], center = true);
translate(v = [0, -0.875, 161.500])
rotate(a = [-45, 0, 0])
#cube(size = [27.000, 3.500, 14.000], center = true);
}
}
